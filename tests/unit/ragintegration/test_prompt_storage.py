"""
TDD Tests für Prompt-Speicherung in ChatMessage

Tests für Phase 3: Prompt Viewer korrigieren
"""
import pytest
...
class TestPromptStorage:
    ...
    def test_prompt_stored_in_chat_message_metadata(self):
        """Test: Prompt wird in ChatMessage.metadata gespeichert."""
        # Mock Repositories
        ...
        mock_ai_service.generate_response_async = Mock(return_value={
            "answer": "Test Antwort",
            "model_used": "gpt-4o-mini",
            "tokens_used": 100,
            "prompt_text": "Test Prompt Text"  # NEU: Prompt in Response
        })
        ...
        from contexts.ragintegration.domain.entities import ChatSession
        ...
        saved_message = ChatMessage(
            ...
            created_at=datetime.now(),
            metadata={"prompt_text": "Test Prompt Text"}  # Erwartete Metadata
        )
        ...
        if call_args:
            ...
            if saved_chat_message and saved_chat_message.metadata:
                ...
                assert saved_chat_message.metadata["prompt_text"] == "Test Prompt Text"
    
    def test_prompt_viewer_shows_correct_prompt(self):
        """Test: Prompt Viewer zeigt den echten Prompt aus metadata."""
        ...
        message = ChatMessage(
            ...
            created_at=datetime.now(),
            metadata={
                "prompt_text": "Dies ist der echte Prompt",
                "tokens_used": 100
            }
        )
        ...
        assert message.metadata["prompt_text"] == "Dies ist der echte Prompt"
