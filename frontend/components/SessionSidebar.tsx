      ...
      <div className="flex-1 overflow-y-auto">
        {isLoadingSessions ? (
          <div className="p-2 text-center">
            ...
            <p className="text-[10px] text-gray-500 mt-1">Lade...</p>
          </div>
        ) : sessions.length === 0 ? (
          <div className="p-2 text-center">
            <MessageSquare className="w-6 h-6 text-gray-400 mx-auto mb-1" />
            <p className="text-[10px] text-gray-500">Keine Sessions</p>
                  ...
                  <div className="flex-shrink-0 ml-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="flex flex-col gap-0.5">
                      <button
                        ...
                        className="p-0.5 text-gray-400 hover:text-blue-600 hover:bg-blue-100 rounded disabled:opacity-50"
                        title="Umbenennen"
                      >
