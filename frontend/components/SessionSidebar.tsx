    ...
    <div className={`flex flex-col h-full bg-white rounded-lg shadow-md border border-gray-200 ${className}`}>
      ...
      <div className="p-2 border-b border-gray-200">
        <div className="flex items-center justify-between mb-2">
          <h2 className="font-semibold text-gray-900 text-xs">Sessions</h2>
          <button
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-1">
              <button
                ...
                className="px-2 py-0.5 bg-blue-600 text-white text-xs rounded hover:bg-blue-700 disabled:opacity-50 flex-1"
              >
                {isCreating ? '...' : 'OK'}
              </button>
              <button
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoadingSessions ? (
          <div className="p-2 text-center">
            ...
            <p className="text-xs text-gray-500 mt-1">Lade...</p>
          </div>
        ) : sessions.length === 0 ? (
          <div className="p-2 text-center">
                  ...
                  <div className="flex-shrink-0 ml-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="flex flex-col gap-1">
                      <button
                        ...
                        className="p-1 text-gray-400 hover:text-blue-600 hover:bg-blue-100 rounded transition-all hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Umbenennen"
                      >
                      ...
                      <button
                        ...
                        className="p-1 text-gray-400 hover:text-red-600 hover:bg-red-100 rounded transition-all hover:scale-110"
                        title="Löschen"
                      >
